...
export const cmsApi = {
  ...
  PRODUCT_STATES: `${env.CMS_URL}/api/product-states`,
  PRODUCT_CATEGORIES: `${env.CMS_URL}/api/product-categories`,
  PRODUCT_SUBCATEGORIES: `${env.CMS_URL}/api/product-subcategories`,
  UPLOAD: `${env.CMS_URL}/api/upload`,
