...
import AccountPaymentsTab from '../account-views/account-payments-tab';
import AccountProductsTab from '../account-views/account-products-tab';
import AccountSalesTab from '../account-views/account-sales-tab';
import AccountEventsTab from '../account-views/account-events-tab';
